...
const page = () => {
  ...
  return (
    <div id='Aboutpage'>
      ...
      We have designed a user-friendly website and application to make booking nearby turfs a breeze. Our platform ensures that you don&apost have to stress about finding a turf , instead, you can focus on enjoying the game. With just a few clicks, you can secure a spot at the best turfs around your location, so you never miss out on the fun.
But that&aposs not all—our app is packed with features tailored to enhance your experience. Whether you&aposre new in town or just looking for some friendly competition, we&aposve got you covered. If you don&apost have friends to play with, no worries! Our app allows you to connect with other players, making it easy to find teammates and make new friends.
...
We have worked hard to ensure our application and website are not only easy to use but also packed with all the features you need to have a great time. So, whether you&aposre a seasoned player or just starting, our app is your go-to solution for a hassle-free turf booking experience.
      </p>
      <div>
